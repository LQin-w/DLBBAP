...
OPTION_TEXTS: dict[str, dict[str, dict[str, str]]] = {
    "zh": {
        ...
        "model.metadata.use_gender": {"name": "启用性别元信息", "desc": "是否把性别作为 metadata 输入，用于构造更接近 BoNet 或 SIMBA 的对照。"},
        "model.metadata.use_chronological": {"name": "启用真实年龄元信息", "desc": "是否把 Chronological age 作为 metadata 输入；关闭后可减弱 SIMBA 风格 identity marker 偏向。"},
    ...
    "en": {
        ...
        "model.metadata.use_gender": {"name": "Use Sex Metadata", "desc": "Whether to include sex as a metadata input for method-aligned comparisons."},
        "model.metadata.use_chronological": {"name": "Use Chronological Age", "desc": "Whether to include chronological age as metadata. Disable it to reduce SIMBA-style identity-marker bias."},
